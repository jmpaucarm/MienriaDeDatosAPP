...
CameraSource.PictureCallback pictureCallback = new CameraSource.PictureCallback() {
    ...
    private class UploadFileToServerRecognizer extends AsyncTask<Void, Integer, String> {
        ...
        public String unpload1() throws Exception {
            String url = "http://10.115.134.36:8000/api/recognize";

            HttpClient client = new DefaultHttpClient();
            HttpPost post = new HttpPost(url);
            MultipartEntity mpEntity = new MultipartEntity();

            //Escoger ruta donde se guarda la imagen
//            String filepath = file_image;
            ...
            mpEntity.addPart("cedula", new StringBody("1718325226"));
            ...
            if (status_code == 200) {
                //Bienvenido sería nombre clase
               // Intent inicio = new Intent (this, .class);
