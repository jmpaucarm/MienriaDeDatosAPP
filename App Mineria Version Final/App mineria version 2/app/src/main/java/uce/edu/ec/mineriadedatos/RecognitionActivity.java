...
public class RecognitionActivity extends AppCompatActivity {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                String mensaje = new UploadFileToServerRecognizer().execute().get();
    ...
    private class UploadFileToServerRecognizer extends AsyncTask<Void, Integer, String> {
        File file_image = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES + "/pics2/" + "usuario.jpg");
        ...
        public String unpload1() throws Exception {
            ...
            String cedula_usuario = getIntent().getStringExtra("cedula_enviada");

            mpEntity.addPart("cedula", new StringBody(cedula_usuario));
            ...
            if (status_code == 200) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //Intent i = new Intent(RecognitionActivity.this, ReconocimientoFacial.class);
                        Intent i = new Intent(RecognitionActivity.this, ActivityBienvenidaUser.class);
                        i.putExtra("jsonEncontrado",jsonobject.toString());
